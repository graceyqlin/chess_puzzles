...
def test_get_fen_block_from_web():
    ...
    print('get_fen_block_from_web function is passed!')
...
def test_get_single_transform_board():
    ...
    print('get_single_transform_board function is passed!')
...
def test_get_aggregate_transform_block():
    ...
    print('get_aggregate_transform_block function is passed!')
